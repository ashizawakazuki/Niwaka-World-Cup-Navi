...
function smarty_tag_eightball($params, \src\vendor\smarty\smarty\src\Template $template): string {
    $answers = [
        'Yes',
        'No',
        'No way',
...
$smarty->registerPlugin(\src\vendor\smarty\smarty\src\Smarty::PLUGIN_FUNCTION, 'eightball', 'smarty_tag_eightball');
```
...
$smarty->registerPlugin(\src\vendor\smarty\smarty\src\Smarty::PLUGIN_COMPILER, 'tplheader', 'smarty_compiler_tplheader');
```
