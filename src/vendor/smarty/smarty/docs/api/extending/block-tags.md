...
function smarty_block_translate($params, $content, \src\vendor\smarty\smarty\src\Template $template, &$repeat) {
...
$smarty->registerPlugin(\src\vendor\smarty\smarty\src\Smarty::PLUGIN_BLOCK, 'translate', 'smarty_block_translate');
```
