...
```php
<?php
$smarty->setCompileCheck(\src\vendor\smarty\smarty\src\Smarty::COMPILECHECK_OFF);
```
...
\src\vendor\smarty\smarty\src\Smarty::$_CHARSET = 'EUC-JP';
$smarty = new \src\vendor\smarty\smarty\src\Smarty();
```
