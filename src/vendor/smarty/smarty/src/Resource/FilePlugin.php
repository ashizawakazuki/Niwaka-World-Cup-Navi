...
class FilePlugin extends BasePlugin {
	 ...
	 */
	public function getFilePath($file, \src\vendor\smarty\smarty\src\Smarty $smarty, bool $isConfig = false) {
		// absolute file ?
		if ($file[0] === '/' || $file[1] === ':') {
	 ...
	 * @return false|int
	 */
	public function getResourceNameTimestamp(string $resourceName, \src\vendor\smarty\smarty\src\Smarty $smarty, bool $isConfig = false) {
