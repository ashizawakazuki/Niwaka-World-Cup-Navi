...
use src\vendor\smarty\smarty\src\BlockHandler\BlockPluginWrapper;
use src\vendor\smarty\smarty\src\Compile\CompilerInterface;
use src\vendor\smarty\smarty\src\Compile\Modifier\BCPluginWrapper as ModifierCompilerPluginWrapper;
use src\vendor\smarty\smarty\src\Compile\Tag\BCPluginWrapper as TagPluginWrapper;
use src\vendor\smarty\smarty\src\Extension\Base;
use src\vendor\smarty\smarty\src\Filter\FilterPluginWrapper;
use src\vendor\smarty\smarty\src\FunctionHandler\BCPluginWrapper as FunctionPluginWrapper;

class BCPluginsAdapter extends Base {

	/**
	 * @var \src\vendor\smarty\smarty\src\Smarty
	 */
	private $smarty;

	public function __construct(\src\vendor\smarty\smarty\src\Smarty $smarty) {
		$this->smarty = $smarty;
	}
	...
	public function getTagCompiler(string $tag): ?\src\vendor\smarty\smarty\src\Compile\CompilerInterface {
		...
		$plugin = $this->findPlugin(\src\vendor\smarty\smarty\src\Smarty::PLUGIN_COMPILER, $tag);
		if ($plugin === null) {
			return null;
		}
	...
	public function getFunctionHandler(string $functionName): ?\src\vendor\smarty\smarty\src\FunctionHandler\FunctionHandlerInterface {
		$plugin = $this->findPlugin(\src\vendor\smarty\smarty\src\Smarty::PLUGIN_FUNCTION, $functionName);
		if ($plugin === null) {
			return null;
		}
		$callback = $plugin[0];
	...
	public function getBlockHandler(string $blockTagName): ?\src\vendor\smarty\smarty\src\BlockHandler\BlockHandlerInterface {
		$plugin = $this->findPlugin(\src\vendor\smarty\smarty\src\Smarty::PLUGIN_BLOCK, $blockTagName);
		if ($plugin === null) {
			return null;
		}
		$callback = $plugin[0];
	...
	public function getModifierCallback(string $modifierName) {
		...
		$plugin = $this->findPlugin(\src\vendor\smarty\smarty\src\Smarty::PLUGIN_MODIFIER, $modifierName);
		if ($plugin === null) {
			return null;
		}
		return $plugin[0];
	...
	public function getModifierCompiler(string $modifier): ?\src\vendor\smarty\smarty\src\Compile\Modifier\ModifierCompilerInterface {
		$plugin = $this->findPlugin(\src\vendor\smarty\smarty\src\Smarty::PLUGIN_MODIFIERCOMPILER, $modifier);
		if ($plugin === null) {
			return null;
		}
		$callback = $plugin[0];
	...
	public function addPreFilter(\src\vendor\smarty\smarty\src\Filter\FilterInterface $filter) {
	...
	public function addPostFilter(\src\vendor\smarty\smarty\src\Filter\FilterInterface $filter) {
	...
	public function addOutputFilter(\src\vendor\smarty\smarty\src\Filter\FilterInterface $filter) {
