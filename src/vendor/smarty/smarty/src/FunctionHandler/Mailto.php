...
class Mailto extends Base {
	...
	public function handle($params, Template $template) {
		...
		$string = '<a href="mailto:' . htmlspecialchars($address, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401, \src\vendor\smarty\smarty\src\Smarty::$_CHARSET) .
			'" ' . $extra . '>' . htmlspecialchars($text, ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401, \src\vendor\smarty\smarty\src\Smarty::$_CHARSET) . '</a>';
		...
		if ($encode === 'javascript') {
			...
			for ($x = 0, $_length = strlen($address); $x < $_length; $x++) {
				if (preg_match('!\w!' . \src\vendor\smarty\smarty\src\Smarty::$_UTF8_MODIFIER, $address[$x])) {
