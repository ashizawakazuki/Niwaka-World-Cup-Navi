...
abstract class ForeachSection extends Base {
	 ...
	 */
	protected function scanForProperties($attributes, \src\vendor\smarty\smarty\src\Compiler\Template $compiler) {
		$this->propertyPreg = '~(';
		$this->startOffset = 1;
		$this->resultOffsets = [];
	 ...
	 * @param \src\vendor\smarty\smarty\src\Compiler\Template $compiler
	 */
	private function matchTemplateSource(\src\vendor\smarty\smarty\src\Compiler\Template $compiler) {
	 ...
	 * @throws \src\vendor\smarty\smarty\src\Exception
	 */
	private function matchParentTemplateSource(\src\vendor\smarty\smarty\src\Compiler\Template $compiler) {
	 ...
	 */
	public function compileSpecialVariable(\src\vendor\smarty\smarty\src\Compiler\Template $compiler, $parameter) {
