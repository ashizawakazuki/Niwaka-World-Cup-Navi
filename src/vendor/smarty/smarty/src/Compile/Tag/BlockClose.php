...
use src\vendor\smarty\smarty\src\ParseTree\Template;
...
class BlockClose extends Inheritance {
	 ...
	 * @return bool true
	 */
	public function compile($args, \src\vendor\smarty\smarty\src\Compiler\Template $compiler, $parameter = array(), $tag = null, $function = null): string
	{
		...
		$output .= (new \src\vendor\smarty\smarty\src\Compiler\CodeFrame($compiler->getTemplate()))->insertLocalVariables();
