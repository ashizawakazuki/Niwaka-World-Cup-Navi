...
class FunctionClose extends Base {
	 ...
	 * @param object|\src\vendor\smarty\smarty\src\Compiler\Template $compiler compiler object
	 *
	...
	public function compile($args, \src\vendor\smarty\smarty\src\Compiler\Template $compiler, $parameter = [], $tag = null, $function = null): string
	{
		...
		$_paramsCode = (new \src\vendor\smarty\smarty\src\Compiler\CodeFrame($compiler->getTemplate()))->insertLocalVariables();
		...
		$compiler->getParser()->current_buffer = new \src\vendor\smarty\smarty\src\ParseTree\Template();
		...
		if ($compiler->getTemplate()->getCompiled()->getNocacheCode()) {
			...
			$compiler->getParser()->current_buffer->append_subtree(
				$compiler->getParser(),
				new \src\vendor\smarty\smarty\src\ParseTree\Tag(
					$compiler->getParser(),
					$output
				)
			);
			...
			$_functionCode = new \src\vendor\smarty\smarty\src\ParseTree\Tag(
				$compiler->getParser(),
