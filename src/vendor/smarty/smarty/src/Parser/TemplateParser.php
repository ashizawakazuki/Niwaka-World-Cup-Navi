...
use src\vendor\smarty\smarty\src\Lexer\TemplateLexer as Lexer;
use src\vendor\smarty\smarty\src\ParseTree\Template as TemplateParseTree;
use src\vendor\smarty\smarty\src\Compiler\Template as TemplateCompiler;
use src\vendor\smarty\smarty\src\ParseTree\Code;
use src\vendor\smarty\smarty\src\ParseTree\Dq;
...
// line 35 "src/Parser/TemplateParser.y"
     ...
     *
     * @var \src\vendor\smarty\smarty\src\ParseTree\Base
     */
...
// line 252 "src/Parser/TemplateParser.y"
    public function yy_r1(){
         ...
         $this->current_buffer->append_subtree($this, new \src\vendor\smarty\smarty\src\ParseTree\Text($text, $this->strip));
    }
...
// line 271 "src/Parser/TemplateParser.y"
    public function yy_r4(){
       $this->current_buffer->append_subtree($this, new \src\vendor\smarty\smarty\src\ParseTree\Text($this->yystack[$this->yyidx + -1]->minor));
    }
...
// line 794 "src/Parser/TemplateParser.y"
    ...
    if ($this->yystack[$this->yyidx + -2]->minor['var'] === '\'smarty\'') {
        $this->compiler->appendPrefixCode("<?php {$prefixVar} = ". (new \src\vendor\smarty\smarty\src\Compile\SpecialVariableCompiler())->compile(array(),$this->compiler,$this->yystack[$this->yyidx + -2]->minor['smarty_internal_index']).';?>');
     } else {
...
// line 887 "src/Parser/TemplateParser.y"
    ...
    if ($this->yystack[$this->yyidx + 0]->minor['var'] === '\'smarty\'') {
        $smarty_var = (new \src\vendor\smarty\smarty\src\Compile\SpecialVariableCompiler())->compile(array(),$this->compiler,$this->yystack[$this->yyidx + 0]->minor['smarty_internal_index']);
...
// line 985 "src/Parser/TemplateParser.y"
    ...
    $this->_retvalue = '['.(new \src\vendor\smarty\smarty\src\Compile\SpecialVariableCompiler())->compile(array(),$this->compiler,'[\'section\'][\''.$this->yystack[$this->yyidx + -1]->minor.'\'][\'index\']').']';
    }
// line 989 "src/Parser/TemplateParser.y"
    public function yy_r134(){
    $this->_retvalue = '['.(new \src\vendor\smarty\smarty\src\Compile\SpecialVariableCompiler())->compile(array(),$this->compiler,'[\'section\'][\''.$this->yystack[$this->yyidx + -3]->minor.'\'][\''.$this->yystack[$this->yyidx + -1]->minor.'\']').']';
    }
...
// line 1056 "src/Parser/TemplateParser.y"
    ...
    if ($this->yystack[$this->yyidx + -1]->minor['var'] === '\'smarty\'') {
        $this->_retvalue = (new \src\vendor\smarty\smarty\src\Compile\SpecialVariableCompiler())->compile(array(),$this->compiler,$this->yystack[$this->yyidx + -1]->minor['smarty_internal_index']).$this->yystack[$this->yyidx + 0]->minor;
    } else {
