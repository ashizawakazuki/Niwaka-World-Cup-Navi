...
class Security {
	 ...
	 * @throws \src\vendor\smarty\smarty\src\Exception if directory is not trusted
	 */
	 ...
	 * @throws \src\vendor\smarty\smarty\src\Exception when an invalid class name is provided
	 */
