...
use src\vendor\smarty\smarty\src\Compile\DefaultHandlerBlockCompiler;
use src\vendor\smarty\smarty\src\Compile\DefaultHandlerFunctionCallCompiler;
use src\vendor\smarty\smarty\src\Compile\ModifierCompiler;
use src\vendor\smarty\smarty\src\Compile\ObjectMethodBlockCompiler;
use src\vendor\smarty\smarty\src\Compile\ObjectMethodCallCompiler;
use src\vendor\smarty\smarty\src\Compile\FunctionCallCompiler;
use src\vendor\smarty\smarty\src\Compile\PrintExpressionCompiler;
use src\vendor\smarty\smarty\src\Lexer\TemplateLexer;
use src\vendor\smarty\smarty\src\Parser\TemplateParser;
use src\vendor\smarty\smarty\src\Smarty;
use src\vendor\smarty\smarty\src\Compile\Tag\ExtendsTag;
use src\vendor\smarty\smarty\src\CompilerException;
use src\vendor\smarty\smarty\src\Compiler\BaseCompiler;
...
class Template extends BaseCompiler {
	 ...
	 * Parser object
	 *
	 * @var \src\vendor\smarty\smarty\src\Parser\TemplateParser
	 */
	private $parser = null;
	 ...
	 * current template
	 *
	 * @var \src\vendor\smarty\smarty\src\Template
	 */
	 ...
	 *
	 * @param \src\vendor\smarty\smarty\src\Template $template template object to compile
	 *
	 * @return string code
	 * @throws Exception
	 */
	public function compileTemplate(\src\vendor\smarty\smarty\src\Template $template) {
	 ...
	 *
	 * @param \src\vendor\smarty\smarty\src\Template $template
	 ...
	 * @throws Exception
	 */
	public function compileTemplateSource(\src\vendor\smarty\smarty\src\Template $template, ?\Smarty\Compiler\Template $parent_compiler = null) {
		try {
	 ...
	 * @param string $tag tag name
	 *
	 * @return ?\src\vendor\smarty\smarty\src\Compile\CompilerInterface tag compiler object or null if not found or untrusted by security policy
	 */
	public function getTagCompiler($tag): ?\src\vendor\smarty\smarty\src\Compile\CompilerInterface {
        $tag = strtolower($tag);
	 ...
	 *
	 * @return bool|\src\vendor\smarty\smarty\src\Compile\Modifier\ModifierCompilerInterface tag compiler object or false if not found or untrusted by security policy
	 */
	 ...
	 *
	 * @throws \src\vendor\smarty\smarty\src\CompilerException when an unexpected token is found
	 */
	...
	private function compileTag2($tag, $args, $parameter) {
		...
		if ($this->smarty->getFunctionHandler($tag)) {
			if (!isset($this->smarty->security_policy) || $this->smarty->security_policy->isTrustedTag($tag, $this)) {
				return (new \src\vendor\smarty\smarty\src\Compile\PrintExpressionCompiler())->compile(
		...
		if ($callback = $this->getPluginFromDefaultHandler($tag, Smarty::PLUGIN_COMPILER)) {
			...
			$tagCompiler = new \src\vendor\smarty\smarty\src\Compile\Tag\BCPluginWrapper($callback);
	...
	/**
	 * @return \src\vendor\smarty\smarty\src\Template|null
	 */
	public function getTemplate(): ?\src\vendor\smarty\smarty\src\Template {
		return $this->template;
	}

	/**
	 * @param \src\vendor\smarty\smarty\src\Template|null $template
	 */
	public function setTemplate(?\src\vendor\smarty\smarty\src\Template $template): void {
		$this->template = $template;
	}
