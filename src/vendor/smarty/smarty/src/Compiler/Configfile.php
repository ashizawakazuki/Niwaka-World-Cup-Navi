...
use src\vendor\smarty\smarty\src\Lexer\ConfigfileLexer;
use src\vendor\smarty\smarty\src\Parser\ConfigfileParser;
...
class Configfile extends BaseCompiler {
	...
	public function compileTemplate(Template $template) {
		...
		$template_header = sprintf(
			...
			\src\vendor\smarty\smarty\src\Smarty::SMARTY_VERSION,
			date("Y-m-d H:i:s"),
