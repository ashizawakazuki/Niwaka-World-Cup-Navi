...
use src\vendor\smarty\smarty\src\Cacheresource\File;
use src\vendor\smarty\smarty\src\Extension\Base;
use src\vendor\smarty\smarty\src\Extension\BCPluginsAdapter;
use src\vendor\smarty\smarty\src\Extension\CallbackWrapper;
use src\vendor\smarty\smarty\src\Extension\CoreExtension;
use src\vendor\smarty\smarty\src\Extension\DefaultExtension;
use src\vendor\smarty\smarty\src\Extension\ExtensionInterface;
use src\vendor\smarty\smarty\src\Filter\Output\TrimWhitespace;
use src\vendor\smarty\smarty\src\Runtime\CaptureRuntime;
use src\vendor\smarty\smarty\src\Runtime\DefaultPluginHandlerRuntime;
use src\vendor\smarty\smarty\src\Runtime\ForeachRuntime;
use src\vendor\smarty\smarty\src\Runtime\InheritanceRuntime;
use src\vendor\smarty\smarty\src\Runtime\TplFunctionRuntime;
 ...
 */
class Smarty extends \src\vendor\smarty\smarty\src\TemplateBase {
	 ...
	 *
	 * @var string
	 * @see \src\vendor\smarty\smarty\src\Security
	 */
	public $security_class = \src\vendor\smarty\smarty\src\Security::class;

	/**
	 * implementation of security class
	 *
	 * @var \src\vendor\smarty\smarty\src\Security
	 */
	 ...
	 *
	 * @var \src\vendor\smarty\smarty\src\Cacheresource\Base
	 */
	 ...
	 * Debug object
	 *
	 * @var \src\vendor\smarty\smarty\src\Debug
	 */
	public $_debug = null;
	...
	public function templateExists($resource_name) {
		...
		$source = \src\vendor\smarty\smarty\src\Template\Source::load(null, $this, $resource_name);
	 ...
	 *
	 * @param string|\src\vendor\smarty\smarty\src\Security $security_class if a string is used, it must be class-name
	 *
	 * @return static                 current Smarty instance for chaining
	 * @throws \src\vendor\smarty\smarty\src\Exception
	 */
	public function enableSecurity($security_class = null) {
		\src\vendor\smarty\smarty\src\Security::enableSecurity($this, $security_class);
		return $this;
	}
	...
	public function testInstall(&$errors = null) {
		\src\vendor\smarty\smarty\src\TestInstall::testInstall($this, $errors);
	}
		...
		foreach ($sourceDir as $_dir) {
			...
			foreach ($_dir_2 as $_fileinfo) {
				...
				try {
					...
					$_tpl->setSource(
						$isConfig ? Template\Config::load($_tpl) : \src\vendor\smarty\smarty\src\Template\Source::load($_tpl)
					);
					if ($_tpl->mustCompile()) {
	...
	public function runPreFilters($source, Template $template) {
		...
		foreach ($this->getExtensions() as $extension) {
			/** @var \src\vendor\smarty\smarty\src\Filter\FilterInterface $filter */
	...
	public function getRuntime(string $type) {
		...
		throw new \src\vendor\smarty\smarty\src\Exception('Trying to load invalid runtime ' . $type);
	}
	...
	public function hasRuntime(string $type): bool {
		try {
			...
			return true;
		} catch (\src\vendor\smarty\smarty\src\Exception $e) {
			return false;
		}
	}
	 ...
	 * @deprecated since 5.0
	 */
	public function registerCacheResource($name, \src\vendor\smarty\smarty\src\Cacheresource\Base $resource_handler) {
	...
	/**
	 * @return \src\vendor\smarty\smarty\src\Cacheresource\Base
	 */
	public function getCacheResource(): \src\vendor\smarty\smarty\src\Cacheresource\Base {
		return $this->cacheResource;
	}

	/**
	 * @param \src\vendor\smarty\smarty\src\Cacheresource\Base $cacheResource
	 */
	public function setCacheResource(\src\vendor\smarty\smarty\src\Cacheresource\Base $cacheResource): void {
