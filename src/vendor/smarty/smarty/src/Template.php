...
use src\vendor\smarty\smarty\src\Template\Compiled;
use src\vendor\smarty\smarty\src\Template\Config;
use src\vendor\smarty\smarty\src\Exception;
use src\vendor\smarty\smarty\src\Smarty;
use src\vendor\smarty\smarty\src\TemplateBase;
...
class Template extends TemplateBase {
	 ...
	 * @param \src\vendor\smarty\smarty\src\Data|null $_parent back pointer to parent object with variables or null
	...
	public function __construct(
                                            $template_resource,
		Smarty                              $smarty,
		?\src\vendor\smarty\smarty\src\Data $_parent = null,
                                            $_cache_id = null,
                                            $_compile_id = null,
                                            $_caching = null,
                                            $_isConfig = false
	...
	private function render($no_output_filter = true, $display = null) {
		...
		if ($this->getSource()->handler->recompiled) {
			$this->caching = \src\vendor\smarty\smarty\src\Smarty::CACHING_OFF;
		}
		...
		try {
			...
			if ($this->caching === \src\vendor\smarty\smarty\src\Smarty::CACHING_LIFETIME_CURRENT || $this->caching === \src\vendor\smarty\smarty\src\Smarty::CACHING_LIFETIME_SAVED) {
	 ...
	 * @param \src\vendor\smarty\smarty\src\Compiler\Template|null $compiler
	 *
	 * @return string
	 * @throws Exception
	 */
	public function createCodeFrame($content = '', $functions = '', $cache = false, ?\src\vendor\smarty\smarty\src\Compiler\Template $compiler = null) {
	...
	private function getCodeFrameCompiler(): \src\vendor\smarty\smarty\src\Compiler\CodeFrame {
		return new \src\vendor\smarty\smarty\src\Compiler\CodeFrame($this);
	}
	...
	private function _execute($function) {
		...
		try {
			...
			if ($smarty->isMutingUndefinedOrNullWarnings()) {
				$errorHandler = new \src\vendor\smarty\smarty\src\ErrorHandler();
