...
class TplFunctionRuntime {
	 ...
	 *
	 * @param \src\vendor\smarty\smarty\src\Template $tpl template object
	...
	public function callTemplateFunction(Template $tpl, $name, $params, $nocache) {
		...
		if (!isset($funcParam)) {
			throw new \src\vendor\smarty\smarty\src\Exception("Unable to find template function '{$name}'");
		}
	 ...
	 *
	 * @param \Smarty|\src\vendor\smarty\smarty\src\Template|\src\vendor\smarty\smarty\src\TemplateBase $obj
