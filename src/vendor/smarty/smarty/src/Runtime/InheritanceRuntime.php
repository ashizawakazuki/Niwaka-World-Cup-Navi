...
namespace src\vendor\smarty\smarty\src\Runtime;
...
class InheritanceRuntime {
	 ...
	 *
	 * @var \src\vendor\smarty\smarty\src\Runtime\Block[]
	 */
	private $childRoot = [];
	 ...
	 *
	 * @param \src\vendor\smarty\smarty\src\Template $tpl template object of caller
	 ...
	 *
	 * @param \src\vendor\smarty\smarty\src\Template $tpl
	...
	public function endChild(Template $tpl, $template = null, ?string $currentDir = null) {
		...
		if (isset($template)) {
			$tpl->renderSubTemplate(
				...
				$tpl->cache_id,
				$tpl->compile_id,
				$tpl->caching ? \src\vendor\smarty\smarty\src\Template::CACHING_NOCACHE_CODE : 0,
				$tpl->cache_lifetime,
				[],
				null,
				$currentDir
	 ...
	 *
	 * @param Template $tpl
	 * @param \src\vendor\smarty\smarty\src\Runtime\Block $block
	 * @param \src\vendor\smarty\smarty\src\Runtime\Block|null $parent
	 *
	 * @throws Exception
	 */
	private function processBlock(
        Template                                     $tpl,
        \src\vendor\smarty\smarty\src\Runtime\Block  $block,
        ?\src\vendor\smarty\smarty\src\Runtime\Block $parent = null
	) {
	 ...
	 * @throws Exception
	 */
	public function callChild(Template $tpl, \src\vendor\smarty\smarty\src\Runtime\Block $block) {
	 ...
	 * @throws Exception
	 */
	public function callParent(Template $tpl, \src\vendor\smarty\smarty\src\Runtime\Block $block) {
	 ...
	 * @param Template $tpl
	 */
	public function callBlock(\src\vendor\smarty\smarty\src\Runtime\Block $block, Template $tpl) {
