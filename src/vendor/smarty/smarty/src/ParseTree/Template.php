...
use src\vendor\smarty\smarty\src\ParseTree\Tag;
use src\vendor\smarty\smarty\src\ParseTree\Text;
...
class Template extends Base
{
     ...
     * @param Base $subtree
     */
    public function append_subtree(\src\vendor\smarty\smarty\src\Parser\TemplateParser $parser, Base $subtree)
    {
     ...
     * @param Base[] $array
     */
    public function append_array(\src\vendor\smarty\smarty\src\Parser\TemplateParser $parser, $array = array())
    {
        if (!empty($array)) {
     ...
     * @param Base[] $array
     */
    public function prepend_array(\src\vendor\smarty\smarty\src\Parser\TemplateParser $parser, $array = array())
    {
        if (!empty($array)) {
