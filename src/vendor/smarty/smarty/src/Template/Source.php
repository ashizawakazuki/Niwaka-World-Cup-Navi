...
class Source {
	 ...
	 * Resource Handler
	 *
	 * @var \src\vendor\smarty\smarty\src\Resource\BasePlugin
	 */
	public $handler = null;
	...
	public function __construct(Smarty $smarty, $type, $name) {
		$this->handler = \src\vendor\smarty\smarty\src\Resource\BasePlugin::load($smarty, $type);
	...
	public function _getDefaultTemplate($default_handler) {
		...
		if (is_string($_return)) {
			...
			$this->handler = \src\vendor\smarty\smarty\src\Resource\BasePlugin::load($this->smarty, 'eval');
		} else {
			$this->exists = false;
			throw new Exception(
	...
	public function createCompiler(): \src\vendor\smarty\smarty\src\Compiler\BaseCompiler {
		return new \src\vendor\smarty\smarty\src\Compiler\Template($this->smarty);
	}
